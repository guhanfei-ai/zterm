  ...
  <nav class="nav-rail">
    ...
    <div class="nav-rail-top">
      ...
      >
        ...
        <span class="nav-rail-label">本地</span>
      </button>
      <button
        class="nav-rail-btn"
      ...
      >
        ...
        <span class="nav-rail-label">远程</span>
      </button>
      <button
        class="nav-rail-btn"
        :class="{ active: activeMode === 'jumpserver' }"
        title="JMP 模式（Jumpserver）"
      ...
      >
        ...
        <span class="nav-rail-label">JMP</span>
      </button>
    </div>
    ...
    <div class="nav-rail-bottom">
      <button class="nav-rail-btn" :title="themeToggleTitle" @click="themeStore.quickToggle()">
        ...
        <span class="nav-rail-label">主题</span>
      </button>
      <button class="nav-rail-btn" title="设置" @click="$emit('open-settings')">
        ...
        <span class="nav-rail-label">设置</span>
      </button>
      <button class="nav-rail-btn" title="关于" @click="$emit('open-about')">
        ...
        <span class="nav-rail-label">关于</span>
      </button>
    </div>
  </nav>
</template>
